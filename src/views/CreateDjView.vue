<template>
  <div id="CreateDjView">
      <Header v-model:name="djName" v-model:kurzbeschreibung="shortDescription" v-model:imagePreview="imagePreview" :onFileChange="onFileChange" />
    <div id="main">
      <div id="left-side">
              ...
              <div v-for="(song, index) in songs" :key="index" class="dish-item">
                <div id="dish-form">
                  <div id="right">
                    ...
                    <input v-model="song.songLength" type="number" min="0" id="input" placeholder="z.B. Länge: 3,41 min">
                    <input v-model="song.songYear" type="date" id="input" placeholder="z.B. Jahr: 2024">
                  </div>
                </div>
              </div>
