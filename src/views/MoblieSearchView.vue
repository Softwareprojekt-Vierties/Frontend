...
#Eventure-Logo-Text {
  ...
  gap: 10px; /* Fügt einen Abstand zwischen den Spalten hinzu */
  background-color: var(--background);
}

#logo {
  width: 50px; /* Bestimmt eine feste Breite für das Logo */
}

#Überschrift {
  font-size: 50px; /* Legt die Schriftgröße für die Überschrift fest */
